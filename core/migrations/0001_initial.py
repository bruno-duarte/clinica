# Generated by Django 3.0.4 on 2020-04-06 02:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sintomas', models.TextField(max_length=500, null=True, verbose_name='Sintomas')),
                ('remedios', models.TextField(max_length=500, null=True, verbose_name='Remedios')),
                ('exames', models.TextField(max_length=500, null=True, verbose_name='Exames')),
                ('estado', models.CharField(choices=[('1', 'Agendada'), ('2', 'Cancelada'), ('3', 'Espera'), ('4', 'Realizada')], default='Agendada', max_length=9, verbose_name='Estado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualização')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo')),
                ('nome', models.CharField(choices=[('1', 'Cardiologia'), ('2', 'Cirurgia'), ('3', 'Clínica Geral'), ('4', 'Gastroenterologia'), ('5', 'Neurologia'), ('6', 'Odontologia'), ('7', 'Oftalmologia'), ('8', 'Ortopedia'), ('9', 'Pediatria')], max_length=50, verbose_name='Especialidade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualização')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo')),
                ('horario', models.CharField(choices=[('1', '08h-09h'), ('2', '09h-10h'), ('3', '10h-11h')], max_length=7, verbose_name='Horario')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualização')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo')),
                ('consultas', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Consulta', verbose_name='Consulta')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='consulta',
            name='hora',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Horario', verbose_name='Horário'),
        ),
        migrations.AddField(
            model_name='consulta',
            name='lista_espera',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Fila', verbose_name='Fila'),
        ),
        migrations.CreateModel(
            name='Paciente',
            fields=[
